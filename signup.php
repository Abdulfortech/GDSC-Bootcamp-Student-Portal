...
<body class="">
  <main> 
    <center>
        <h2 class="text-center text-success fw-bold mt-5">Student Portal App</h2>
              ...
              <div class="card-body text-start p-0">
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" name="reg" class="form-control" placeholder="Your Registration Number" required>
                  </div>
                </div>
