<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top rounded" aria-label="Eleventh navbar example">
    <div class="container-fluid">
        ...
        <h2 class="text-success"><b>Mobilizing App</b></h2>
        </a>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="faculties">Faculties</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="departments">Departments</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="requests">Requests</a>
            </li>
            <li class="nav-item">
