  ...
  <main>
	...
	<section class="farko p-3 mt-5">
        ...
        <div class="col-md-5">    
            ...
            <h1 class="featurette-heading fw-bold mt-4 mb-5 text-success">Edit <span class="text-color2">Department</span></h1>
            <form method="POST" action="process.php">
                ...
                <button class="w-100 btn btn-lg btn-success" type="submit" name="editDepartment">Save Department</button>
            </form>
            </div>
        </div>
        </center>
